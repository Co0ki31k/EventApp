...
<section class="guest-hero">
	<div class="hero-inner">
		<div class="hero-left">
			...
			<a class="btn btn-primary btn-map" href="<?= url('guest-home.php') ?>"><span class="btn-label">Zobacz mapę wydarzeń</span> <span class="btn-arrow">→</span></a>
		</div>
			...
			<div class="role-half">
				...
				<div class="role-card orange">
					<div class="role-content">
						...
						<div class="role-cta">
							<a class="role-btn" href="<?= url('register.php') ?>">Rozpocznij</a>
						</div>
					</div>
				</div>
			</div>
